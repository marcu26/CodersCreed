...
namespace Core.Migrations
{
    ...
    [Migration("20230401172548_ProjectAndProjectUser")]
    partial class ProjectAndProjectUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Database.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 1, 20, 25, 48, 240, DateTimeKind.Local).AddTicks(8480),
                            Title = "Administrator"
                        },
                        new
                        {
                            Id = 2,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 1, 20, 25, 48, 240, DateTimeKind.Local).AddTicks(8513),
                            Title = "Manager"
                        },
                        new
                        {
                            Id = 3,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 1, 20, 25, 48, 240, DateTimeKind.Local).AddTicks(8515),
                        ...
                        new
                        {
                            Id = 4,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 1, 20, 25, 48, 240, DateTimeKind.Local).AddTicks(8516),
                            Title = "User"
                        });
                });
            ...
            modelBuilder.Entity("Core.Database.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "YWRtaW4=",
                            Points = 0,
                            Timestamp = new DateTime(2023, 4, 1, 20, 25, 48, 240, DateTimeKind.Local).AddTicks(8602),
                            Username = "admin"
                        });
                });
