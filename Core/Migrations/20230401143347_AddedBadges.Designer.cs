...
namespace Core.Migrations
{
    ...
    [Migration("20230401143347_AddedBadges")]
            ...
            modelBuilder.Entity("Core.Database.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 1, 17, 33, 47, 561, DateTimeKind.Local).AddTicks(1406),
                            Title = "Administrator"
                        },
                        new
                        {
                            Id = 2,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 1, 17, 33, 47, 561, DateTimeKind.Local).AddTicks(1445),
                            Title = "Manager"
                        },
                        new
                        {
                            Id = 3,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 1, 17, 33, 47, 561, DateTimeKind.Local).AddTicks(1447),
                        ...
                        new
                        {
                            Id = 4,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 1, 17, 33, 47, 561, DateTimeKind.Local).AddTicks(1448),
                            Title = "User"
                        });
                });
            ...
            modelBuilder.Entity("Core.Database.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "YWRtaW4=",
                            Points = 0,
                            Timestamp = new DateTime(2023, 4, 1, 17, 33, 47, 561, DateTimeKind.Local).AddTicks(1530),
                            Username = "admin"
                        });
                });
