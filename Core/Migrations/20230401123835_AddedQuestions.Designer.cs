...
namespace Core.Migrations
{
    ...
    [Migration("20230401123835_AddedQuestions")]
            ...
            modelBuilder.Entity("Core.Database.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 1, 15, 38, 35, 149, DateTimeKind.Local).AddTicks(3208),
                            Title = "Administrator"
                        },
                        new
                        {
                            Id = 2,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 1, 15, 38, 35, 149, DateTimeKind.Local).AddTicks(3242),
                            Title = "Manager"
                        },
                        new
                        {
                            Id = 3,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 1, 15, 38, 35, 149, DateTimeKind.Local).AddTicks(3244),
                        ...
                        new
                        {
                            Id = 4,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 1, 15, 38, 35, 149, DateTimeKind.Local).AddTicks(3246),
                            Title = "User"
                        });
                });
            ...
            modelBuilder.Entity("Core.Database.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "YWRtaW4=",
                            Points = 0,
                            Timestamp = new DateTime(2023, 4, 1, 15, 38, 35, 149, DateTimeKind.Local).AddTicks(3326),
                            Username = "admin"
                        });
                });
