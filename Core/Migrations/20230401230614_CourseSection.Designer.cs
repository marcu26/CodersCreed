...
namespace Core.Migrations
{
    ...
    [Migration("20230401230614_CourseSection")]
            ...
            modelBuilder.Entity("Core.Database.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 2, 2, 6, 14, 398, DateTimeKind.Local).AddTicks(9155),
                            Title = "Administrator"
                        },
                        new
                        {
                            Id = 2,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 2, 2, 6, 14, 398, DateTimeKind.Local).AddTicks(9184),
                            Title = "Manager"
                        },
                        new
                        {
                            Id = 3,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 2, 2, 6, 14, 398, DateTimeKind.Local).AddTicks(9186),
                        ...
                        new
                        {
                            Id = 4,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 2, 2, 6, 14, 398, DateTimeKind.Local).AddTicks(9188),
                            Title = "User"
                        });
                });
            ...
            modelBuilder.Entity("Core.Database.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "YWRtaW4=",
                            Points = 0,
                            Timestamp = new DateTime(2023, 4, 2, 2, 6, 14, 398, DateTimeKind.Local).AddTicks(9288),
                            Username = "admin"
                        });
                });
