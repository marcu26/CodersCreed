            ...
            modelBuilder.Entity("Core.Database.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 2, 0, 55, 48, 142, DateTimeKind.Local).AddTicks(6775),
                            Title = "Administrator"
                        },
                        new
                        {
                            Id = 2,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 2, 0, 55, 48, 142, DateTimeKind.Local).AddTicks(6809),
                            Title = "Manager"
                        },
                        new
                        {
                            Id = 3,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 2, 0, 55, 48, 142, DateTimeKind.Local).AddTicks(6811),
                        ...
                        new
                        {
                            Id = 4,
                            IsDeleted = false,
                            Timestamp = new DateTime(2023, 4, 2, 0, 55, 48, 142, DateTimeKind.Local).AddTicks(6813),
                            Title = "User"
                        });
                });
            ...
            modelBuilder.Entity("Core.Database.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "YWRtaW4=",
                            Points = 0,
                            Timestamp = new DateTime(2023, 4, 2, 0, 55, 48, 142, DateTimeKind.Local).AddTicks(6926),
                            Username = "admin"
                        });
                });
